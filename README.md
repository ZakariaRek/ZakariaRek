...
<h1 align="center">
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.herokuapp.com?font=Righteous&pause=1000&color=667EEA&size=35&center=true&vCenter=true&random=false&width=600&lines=Hi+there!+%F0%9F%91%8B+I'm+Zakaria+Rekhla;DevOps+%7C+Kubernetes;Spring+Boot+%26+Microservices;CNCF+CERTIFIED;Cloud+Native+Developer" alt="Typing SVG" />
  </a>
</h1>
...
- ⚡ Fun fact: **Hackathon Winner 🏆 | Always exploring new tech trends**
...
<details><summary><h3>🏢 Recent Internships & Projects</h3></summary>

### Norsys Africa (Marrakech) - Full Stack Developer *(May 2024 - June 2024)*
- Designed interconnected mobile and web application for blood pressure monitoring
- Integrated AI for predictive analysis and health surveillance
...
- Developed MedConnect: comprehensive web application for digitizing medical records
- Automated activity report generation for occupational health units
...
- Developed comprehensive web platform for library management automation
- Implemented analytics dashboard and automated notification system
